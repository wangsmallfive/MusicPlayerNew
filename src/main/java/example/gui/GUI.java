...
public class GUI extends Application {
    ...
    public void start(Stage stage) {
        ...
        try {
            FXMLLoader tab = new FXMLLoader(getClass().getResource("../../fxml/TopAndBottomPage.fxml"),
                    ResourceBundle.getBundle("ini"));
            permanent = (BorderPane) tab.load();
            tabC = tab.getController();

            FXMLLoader ll = new FXMLLoader(getClass().getResource("../../fxml/LeftMusicList.fxml"),
                    ResourceBundle.getBundle("ini"));
            leftlist = (AnchorPane) ll.load();
            llC = ll.getController();

            FXMLLoader pl = new FXMLLoader(getClass().getResource("../../fxml/PlayListPage.fxml"),
                    ResourceBundle.getBundle("ini"));
            playlist = (AnchorPane) pl.load();
            plC = pl.getController();

            FXMLLoader pp = new FXMLLoader(getClass().getResource("../../fxml/PlayPage.fxml"),
                    ResourceBundle.getBundle("ini"));
        ...
        cssList.add("example/css/topandbottom/TopAndBottomPage.css");
        cssList.add("example/css/left/LeftMusicPage.css");
        cssList.add("example/css/local/LocalMusicPageCss.css");
        cssList.add("example/css/play/PlayPageCss.css");
        cssList.add("example/css/search/SearchPageCss.css");
        cssList.add("example/css/musiclist/MusicListPageCss.css");
        cssList.add("example/css/playList/PlayListPageCss.css");
        scene.getStylesheets().addAll(cssList);

        stage.getIcons().add(new Image("example/css/topandbottom/desktopTitle.png"));
