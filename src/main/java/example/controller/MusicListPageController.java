...
public class MusicListPageController implements ContentController, StackController {
    ...
    private void onSearchMusic(ActionEvent event) {//“查找音乐”按钮id
        ...
        List<MusicUtils> ml = MainAction.searchsong(TextField_searchListMusic.getText(), GlobalVariable.SEARCHMODE_HYBRID,"local");
    ...
    public void initData(MainAction ma, String name, String date, List<MusicUtils> list) {
        ...
        TableColumn_like.setEditable(true);
        TableView_musicTable.setEditable(true);
        TableColumn_like.setSortable(false);
    ...
    private void setCss() {
        ...
        ImageView_ListCover.setImage(new Image("example/css/musiclist/demoMusicList.jpg"));
