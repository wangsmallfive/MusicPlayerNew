...
public class Page {
    ...
    public class UpDownlodeLocalPage extends Page {

        public UpDownlodeLocalPage(ServerMusicPageController controller) {
            super();
            setCtrl(controller);
            setType(Controller.LOCAL);
        }
    ...
    public static Page newPage(int type, Parent page, Controller controller) {
        ...
        switch (type) {
            ...
            case Controller.SERVER:
                p = P.new UpDownlodeLocalPage((ServerMusicPageController) controller);
                break;
        }
        p.setType(type);
        p.setPage(page);
