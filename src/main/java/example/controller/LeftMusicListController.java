...
public class LeftMusicListController implements Controller {
    ...
    @FXML
    private Button Button_upDownlodeMusic;//"上传下载服务器音乐"按钮的id
    ...
    public Button getButton_upDownlodeMusic() {
        return Button_upDownlodeMusic;
    }
    ...
    @FXML
    private void onupDownlodeMusic(ActionEvent event) {//按钮“上传下载服务器音乐”的id
        ma.onupDownlodeMusic();
    }
    @FXML
...
//		initPlayer();
    ...
    private void setCss() {
        ...
        Button_upDownlodeMusic.getStyleClass().add("lightButton");
        ...
        ImageView_albumCover.setImage(new Image("example/css/left/demo.png"));
