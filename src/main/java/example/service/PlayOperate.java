...
import example.Global.ObserverManage;
...
//				System.out.println("快进中:"+currPro);
    ...
    private void playInfoMusic(MusicUtils song) {
        ...
        if(song.getPath().contains("http")){
            String Url = null;
            String newUrl= song.getPath().replaceAll(" ","%20").replaceAll(",","%2C")
                    ;
            System.out.println(newUrl);
            mediaPlayer2 = new MediaPlayer(new Media(newUrl));
...
//								}
    ...
    private void alterVolume(int volume) {
        ...
        if (mediaPlayer2 != null) {
            mediaPlayer2.setVolume((float) (volume * 1.0 / 100));
        }
    }
